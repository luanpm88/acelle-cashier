<?php return array (
 ...
 <br> ブラウザはまもなく次のページにリダイレクトされます。',
  ...
  'coinpayments.intro' => 'Bitcoin、Monero、ZCash などの多くの暗号通貨からの支払いを受け入れることができます。Coin-Payments アカウントにサインアップし、統合 ID とキーを取得して、以下で設定する必要があります。',
  'coinpayments.ipn_secret' => 'IPN secret',
  'coinpayments.list_intro' => 'Bitcoin、Monero、ZCash などの暗号通貨から支払いを受け取ります。',
  'coinpayments.merchant_id' => 'Merchant ID',
  'coinpayments.next_period_day' => 'Next period end day',
  'coinpayments.pending.intro' => '未払いの請求書があります。<strong>チェックアウト URL</strong> をクリックして支払うか、下の <strong>ステータス URL</strong> をクリックして支払い/支払いステータスを確認してください。',
  ...
  'coinpayments.short_description' => 'サブスクリプションとサービスの料金を、coinpayment.com 経由で暗号通貨で支払います',
