    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="col-md-8 text-center" style="margin-top: 30vh">
                <div class="mb-40">
                    <img src="{{ \App\Cashier\Cashier::public_url('images/loading.gif') }}" />
                </div>
                ...
                <div class="sub-section">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form id="pay_now" method="POST" action="{{ \App\Cashier\Cashier::lr_action('\App\Cashier\Controllers\CoinpaymentsController@checkout', [
